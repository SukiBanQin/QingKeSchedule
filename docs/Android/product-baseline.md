...
更新日期：2026-09-08。用户已确认本文档；P1-01 已完成修正和[独立审查](p1-01-review.md)。P1-03 已升级至 API 37，工具链和主机侧验证通过专项复审；P1-03-R2 的源码／依赖层说明与失败证据通过复审，但 API 37 设备门槛仍待 P1-03-R3，详见 [P1-03 专项复审](p1-03-review.md)。
...
- D02：已确认包名 `com.qingke.schedule`、最低 API 26。P1-03 已将 `compileSdk`／`targetSdk` 升至 API 37.0，并采用 AGP 9.4.0、Gradle 9.6.0、Build Tools 36.0.0、JDK 17；主机侧构建与测试已经独立复核，API 37 设备安装启动及 Android 17 行为变化适用性记录尚未完成。目标机型与后续完整验证系统清单待定。
