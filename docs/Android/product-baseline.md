...
更新日期：2026-09-08。用户已确认本文档；P1-01 已完成修正和[独立审查](p1-01-review.md)。P1-03 已升级至 API 37，工具链和主机侧验证通过专项复审，但 API 37 设备证据及目标版本行为变化检查仍待 P1-03-R1 补齐，详见 [P1-03 专项复审](p1-03-review.md)。
