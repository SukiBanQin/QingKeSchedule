...
准确状态是 P3-03-R2 与 P3-04 用户视觉验收均已通过；P3-04 按“源课程位置＋打开时数据指纹”精确操作
重复 ID 课程，业务 ID、导入协议和共享 schema 不变，iOS 同步未授权。A04／A05 当前实现范围已经完成，
但 A01—A11 尚未全部验收，A02、A03、A06—A11、整个 P3 和完整 App 仍未完成验收；后续阶段未授权。
