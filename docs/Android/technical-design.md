...
更新日期：2026-09-08。状态：用户已确认方案；P1-01 及两轮修正已完成[独立审查](p1-01-review.md)。P1-03 已升级到经 D02 核对的 API 37.0 组合，工具链和主机侧验证通过[专项复审](p1-03-review.md)；P1-03-R1 的设备失败记录有效，依赖层行为说明与 API 37 设备证据仍待 P1-03-R2，不代表完整应用或设备验收。
