...
更新日期：2026-09-08。状态：用户已确认方案；P1-01 及两轮修正已完成[独立审查](p1-01-review.md)。P1-03 已升级到经 D02 核对的 API 37.0 组合，工具链和主机侧验证通过[专项复审](p1-03-review.md)；P1-03-R2 的源码／依赖层说明与失败证据通过复审，但 API 37 设备门槛仍待 P1-03-R3，不代表完整应用或设备验收。
